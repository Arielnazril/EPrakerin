...
<body class="bg-gray-50 min-h-screen flex flex-col font-sans">
    ...
    {{-- WRAPPER UTAMA UNTUK LOGIN (kode kamu tidak diubah di dalam sini) --}}
    <div class="flex-1 flex items-center justify-center py-10 px-4">
        <div class="w-full max-w-5xl">
            ...
            <div class="flex flex-col lg:flex-row w-full bg-white rounded-3xl shadow-2xl overflow-hidden">
                ...
                <div
                    class="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-primary-blue to-blue-900 items-center justify-center relative p-12">
                    <div class="relative z-10 text-center text-white">
                        <!-- KARTU PUTIH UNTUK LOGO -->
                        <div class="w-32 h-32 mx-auto mb-6 rounded-3xl bg-white shadow-xl flex items-center justify-center">
                ...
                <div class="w-full lg:w-1/2 flex items-center justify-center p-8 lg:p-16 bg-white">
                    <div class="w-full max-w-md">
                        ...
                        @if (session('status_pending'))
                            <div
                                class="mb-6 bg-yellow-50 border-l-4 border-yellow-400 p-4 rounded shadow-sm animate-pulse">
                        ...
                        <form action="{{ route('login.store') }}" method="POST" class="space-y-6">
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">NIS (Nomor Induk
                                    Siswa)</label>
                        ...
                        <div class="mt-8 text-center pt-4 border-t border-gray-100">
                            ...
                            <a href="{{ route('register') }}"
                                class="font-bold text-secondary-blue hover:underline">Daftar Akun Siswa</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    {{-- FOOTER PERSIS DI BAWAH LOGIN --}}
    <footer class="bg-blue-50 border-t border-blue-100 w-full">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <div class="flex flex-col md:flex-row items-center justify-between gap-3">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <p class="text-blue-900 font-bold text-sm sm:text-base">e-Prakerin</p>
                        <p class="text-blue-400 text-[11px] tracking-widest font-semibold">
                            Sistem Informasi Manajemen Praktik Kerja Industri
                        </p>
                    </div>
                </div>

                <p class="text-blue-400 text-[11px] sm:text-xs text-center md:text-right">
