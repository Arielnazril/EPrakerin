            ...
            <header class="bg-white shadow-sm z-20 h-16 flex items-center justify-between px-6 sticky top-0">
                ...
                <div class="flex items-center space-x-4">
                    <div class="text-right hidden md:block">
                        ...
                        <div class="text-xs text-green-600 uppercase font-bold">SISWA MAGANG</div>
                    </div>
                    <div class="h-10 w-10 rounded-full bg-green-600 text-white flex items-center justify-center font-bold">
