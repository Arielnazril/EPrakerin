<aside id="sidebar" class="bg-[--color-primary-dark] text-white flex flex-col z-30 sidebar-transition h-screen shadow-2xl overflow-hidden fixed lg:static inset-y-0 left-0">
    ...
    <div class="h-16 flex items-center justify-center border-b border-white/10 shadow-sm bg-purple-900/50">
        <div class="flex items-center space-x-3 px-4">
            ...
            <div class="sidebar-header-text transition-all duration-300 overflow-hidden whitespace-nowrap">
                <h1 class="text-lg font-bold tracking-wide leading-none">MENTOR</h1>
                <p class="text-[10px] text-purple-200 uppercase tracking-wider">Industri Panel</p>
            </div>
        </div>
    </div>
    ...
    <div class="flex-1 overflow-y-auto py-4 px-3 custom-scrollbar space-y-1">
        ...
        @include('admin.partials.sidebar_item', ['route' => 'industri.dashboard', 'icon' => 'fas fa-tachometer-alt', 'label' => 'Dashboard'])

        <div class="pt-4 pb-2 px-3 text-[10px] font-bold text-purple-300 uppercase tracking-wider sidebar-text whitespace-nowrap">Monitoring Siswa</div>
